        ...
        <div class="card-header h3">
            <div class="row">
                <div class="col-lg-9 col-sm-9">
                    ...
                    echo $form->field($model, "max_score")->hiddenInput()->label(false);

                    ?>
                    <?php
                    echo $model->id ? 'Update  Score Card' : "New Score Card"  ?>
                ...
                <div class="">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12">
                            <h5>Score Sheet</h5>
                            <p>Input the scores / points acquired by each team</p>
                        </div>
                                ...
                                <?php foreach ($teams as $index => $item) : ?>
                                    ...
                                    <tr class="item mb-0 mt-0">
                                        ...
                                        <td valign="middle" class="mb-0 mt-0">
                                            ...
                                            $score = $query != null ? $query->score : 0;
                                            $remarks = $query != null ? $query->remarks : '';

                                            ?>
                                            <?= $form->field($item, "[{$index}]score")
                                                ->textInput([
                                                    'type' => 'number',
                                                    'min' => '0',
                                                    'max' => $model->max_score,
                                        ...
                                        <td valign="middle" class="mb-0 mt-0">
                                            <?= $form->field($item, "[{$index}]remarks")
                                                ->textInput([
                                                    'value' => $remarks,
                                                    'placeholder' => 'You may input ranking or notes here'
                                                ])
                                                ->label(FALSE); ?>
                                        </td>
                                    </tr>
