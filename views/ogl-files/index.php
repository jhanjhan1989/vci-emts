                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value'         => function ($model, $key, $index) {
                             return  $model->has_Ogl()?
                                "OGL-" . date("M-y-") . str_pad($model->has_Ogl()->control_no, 3, "0", STR_PAD_LEFT)
                                :
                                ''; 
                        },
                    ],
                    ...
                    [
                        ...
                        'urlCreator' => function ($action, OglFiles $model, $key, $index, $column) {
